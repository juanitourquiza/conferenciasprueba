...
class __TwigTemplate_e52d1a4200cafdd8a601f65bfafd18b1e0f2696cb66dd736197ba3f3c78ac42d extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["conferencia"]) {
            ...
            echo "            <tr>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["conferencia"], "id", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["conferencia"], "nombre", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["conferencia"], "descripcion", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["conferencia"], "duracion", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("conferencias_show", ["id" => twig_get_attribute($this->env, $this->source, $context["conferencia"], "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("conferencias_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["conferencia"], "id", [], "any", false, false, false, 27)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
{% block title %}Conferencias index{% endblock %}

{% block body %}
    <h1>Conferencias index</h1>
    ...
    <table class=\"table\">
        ...
        {% for conferencia in conferencias %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('conferencias_show', {'id': conferencia.id}) }}\">show</a>
    ...
    <a href=\"{{ path('conferencias_new') }}\">Create new</a>
{% endblock %}
